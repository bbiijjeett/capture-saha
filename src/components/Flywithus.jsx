  ...
  return (
    <div id='flywithus' className={`relative h-full md:h-[60vh] w-full  flex flex-col p-10 gap-10 justify-center items-center rounded-3xl border-black overflow-hidden `}>
        ...
        <a
          ...
          class="flex justify-center text-[#8C52FF] gap-2 items-center mx-auto shadow-xl text-lg bg-gray-50 backdrop-blur-md lg:font-semibold isolation-auto border-gray-50 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[#8C52FF] hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
        >
          Schedule call
          <svg
            class="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-50 text-[#8C52FF] ease-linear duration-300 rounded-full border border-[#8C52FF] group-hover:border-none p-2 rotate-45"
            viewBox="0 0 16 19"
          ...
          >
            ...
            <path
              ...
              class="fill-[#8C52FF] group-hover:fill-gray-800"
            ></path>
          </svg>
        </a>
