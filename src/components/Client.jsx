        ...
        {testimonials.map((i, index) => (
          ...
          >
            <div className="relative w-full h-full overflow-hidden rounded-sm">
              ...
              />
              <div className="absolute top-0 left-0  -translate-x-2  w-3/5 h-full p-4 bg-gradient-to-r from-black to-transparent opacity-0 group-hover:opacity-100  transition-all duration-500 ease-in-out">
